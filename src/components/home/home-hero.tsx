  ...
  return (
    <HeroDepth>
      <header className="max-w-4xl">
        ...
        <h1 className="mt-5 max-w-3xl text-4xl font-semibold leading-[1.12] tracking-tight sm:mt-6 sm:text-5xl sm:leading-[1.1]">
        ...
        <p className="mt-5 max-w-lg text-lg leading-relaxed text-black/75 sm:mt-6">
          {subtitle}
        </p>
