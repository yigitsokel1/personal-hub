  ...
  return (
    <main>
      ...
      <div className="mt-3 min-h-5 text-sm">
        {params.status === "saved" ? <p className="text-green-700">Lab saved.</p> : null}
        {params.status === "deleted" ? <p className="text-green-700">Lab deleted.</p> : null}
      ...
      {items.length === 0 ? (
        <p className="mt-8 text-sm text-black/55">No labs yet.</p>
      ) : (
